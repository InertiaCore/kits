        ...
        <div className="flex flex-col gap-y-4 p-4">
            ...
            <ul className="list-inside list-disc">
                ...
                <li>
                    ...
                    <code>Vite</code> runs in the background automatically, so
            ...
            <p className="text-lg">
                ...
                application based on the <code>Vite</code> template. If you open
                a command prompt in that directory, you can run <code>npm</code>{' '}
                commands such as <code>npm test</code> or{' '}
...
Index.layout = (page: Page<{ title: string }>) => (
    <Layout
        title={page.props.title}
        children={page as unknown as React.ReactNode}
    />
);
