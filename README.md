...
This repository contains examples of how to use [InertiaCore](https://github.com/kapi2289/InertiaCore), an [Inertia.js](https://inertiajs.com/) server-side adapter for .NET.
